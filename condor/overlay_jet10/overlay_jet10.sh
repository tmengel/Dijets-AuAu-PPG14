...
initialDir="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/overlay_jet10"
configFile="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/overlay_jet10/config.txt"
...
MACRODIR="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/overlay_jet10/macros"
cd "$MACRODIR" || exit 1
...
OUTDIR="/sphenix/tg/tg01/jets/tmengel/ppg14/overlay_jet10"
mkdir -p "$OUTDIR"

OUTFILE="${OUTDIR}/overlay_jet10_$(printf "%05d" "$PROCESS").root"
