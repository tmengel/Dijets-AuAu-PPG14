...
initialDir="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/hijing"
configFile="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/hijing/config.txt"
...
MACRODIR="/sphenix/user/tmengel/Dijets-AuAu-PPG14/condor/hijing/macros"
cd "$MACRODIR" || exit 1
...
OUTDIR="/sphenix/tg/tg01/jets/tmengel/ppg14/hijing"
mkdir -p "$OUTDIR"

OUTFILE="${OUTDIR}/hijing_$(printf "%05d" "$PROCESS").root"
